...
final class CalendarStore {
    ...
    var simulationDate: Date { get { now } set { simulationOffset = newValue.timeIntervalSinceNow; simulationEnabled = true; focusedDate = Calendar.current.startOfDay(for: newValue) } }
